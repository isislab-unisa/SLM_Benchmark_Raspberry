...
def main():
    parser = argparse.ArgumentParser(description="Esegui test multipli su un singolo modello (Versione PC).")
    ...
    log_file = os.path.join("output", f"{safe_model_name}_{count}_tests_pc.txt")
    ...
    try:
        print(f"==================================================")
        print(f" AVVIO BENCHMARK SINGOLO MODELLO (PC): {model.upper()}")
